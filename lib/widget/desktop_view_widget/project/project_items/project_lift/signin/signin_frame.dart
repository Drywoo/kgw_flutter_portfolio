...
import 'package:kgw_flutter_portfolio/widget/desktop_view_widget/project/project_items/project_lift/signin/signin.dart';
import 'package:kgw_flutter_portfolio/widget/desktop_view_widget/project/project_viewer_structure.dart';

class LiftSignInScreenFrame extends StatefulWidget {
  const LiftSignInScreenFrame({super.key});

  @override
  State<LiftSignInScreenFrame> createState() => _LiftSignInScreenFrameState();
}

class _LiftSignInScreenFrameState extends State<LiftSignInScreenFrame> {
  @override
                  ...
                  children: [
                    Expanded(
                      ...
                      child: PreviewTextArea(
                        ...
                        content: LiftSignInScreen(context),
                      ),
                    ),
                    const Expanded(
                      flex: 1,
