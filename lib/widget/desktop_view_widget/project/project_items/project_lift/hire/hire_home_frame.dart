...
class LiftHireScreenFrame extends StatefulWidget {
  const LiftHireScreenFrame({super.key});

  @override
  State<LiftHireScreenFrame> createState() => _LiftHireScreenFrameState();
}

class _LiftHireScreenFrameState extends State<LiftHireScreenFrame> {
  @override
                  ...
                  children: [
                    Expanded(
                      ...
                      child: PreviewTextArea(
                        ...
                        content: LiftHireScreen(context),
                      ),
                    ),
                    const Expanded(
                      flex: 1,
