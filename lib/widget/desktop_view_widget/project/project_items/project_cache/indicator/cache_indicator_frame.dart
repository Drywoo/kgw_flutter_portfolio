...
class CacheIndicatorFrame extends StatefulWidget {
  const CacheIndicatorFrame({super.key});

  @override
  State<CacheIndicatorFrame> createState() => _CacheIndicatorFrameState();
}

class _CacheIndicatorFrameState extends State<CacheIndicatorFrame> {
  @override
                  ...
                  children: [
                    Expanded(
                      ...
                      child: PreviewTextArea(
                        ...
                        content: cache_Recommend_Indicator()
                      ),
                    ),
                    Expanded(
                      flex: 1,
