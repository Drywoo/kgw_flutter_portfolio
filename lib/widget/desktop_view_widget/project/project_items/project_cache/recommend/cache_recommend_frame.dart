...
class CacheRecommendScreenFrame extends StatefulWidget {
  const CacheRecommendScreenFrame({super.key});

  @override
  State<CacheRecommendScreenFrame> createState() => _CacheRecommendScreenFrameState();
}

class _CacheRecommendScreenFrameState extends State<CacheRecommendScreenFrame> {
  @override
